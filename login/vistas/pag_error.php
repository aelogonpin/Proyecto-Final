...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <img width="50px" height="50px"
            src="https://static-cdn.jtvnw.net/jtv_user_pictures/de3f3df2-4a4b-432c-8d6c-8e27199ed9a8-profile_image-300x300.jpeg"
            alt="" />
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="http://192.168.48.169/login/vistas/pag_error.php">Home <span
                ...
                <li>
                    <div>
                <li>
                    <a class="btn btn-outline-danger my-2 my-sm-0" href="../bd/logout.php" role="button">Cerrar
                        Sesión</a>
                </li>
        </div>
        </li>
        ...
        <div class="container">
            ...
            <p><a class="btn btn-secondary" href="lugares/creaciones/index.html" role="button">Crear cuenta &raquo;</a></p>
                ...
                <div class="col-md-4">
                    ...
                    <p>
                        Si necesitas mas privilegios para administrar el servidor pulsa
                        aqui y rellena este formulario para solicitarlo
                    </p>
                    <p>
                        <a class="btn btn-secondary" href="lugares/creaciones/index.html" role="button">Here &raquo;</a>
                    </p>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <p>Server</p>
                    <p>
                        <a class="btn btn-secondary" href="https://192.168.48.173:8006" role="button">Entrar &raquo;</a>
                    </p>
                </div>
            </div>
