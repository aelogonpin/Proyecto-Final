...
<h2>Direcciones DNS</h2>
    ...
    <form action="" method="post">
      <input type="text" placeholder="Nombre del dominio" name="nombre">
      <input type="text" placeholder="Dirección IP" name="ip">
      <input type="submit" name="script1" value="Añadir direccion">
    </form>
              <br><br><br>

    <form action="" method="post">
      <input type="text" placeholder="Nombre" name="nombre2">
      <input type="submit" name="script3" value="Eliminar direccion">
    </form>
              <br><br><br>
...
if (isset($_POST['script2'])) {
 ...
 ssh2_auth_password($connection, 'root', 'Admin.123');
  ...
  echo '<script> window.location.href = "../serviciodns"; </script>'; 
...
if (isset($_POST['script3'])) {
  $parametro3 = $_POST['nombre2'];
  $connection = ssh2_connect('192.168.48.102',22);
 ssh2_auth_password($connection, 'root', 'Admin.123');
  $comando = "/essentials/borrardireccion.sh ".$parametro3 ;
  $stream = ssh2_exec($connection, $comando);
